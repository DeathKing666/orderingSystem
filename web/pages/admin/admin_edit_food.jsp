						...
						<div class="card-body">
							...
							<div class="form-group">
								<label for="price">菜品价格</label> <input type="number"
									...
									required="required" value="${food.price }" />
							...
							<div class="form-group">
								...
								<img src="${pageContext.request.contextPath }/${food.picture }">
							</div>
							<div class="form-group">
								<label for="comment">菜品备注</label> <input type="text"
									class="form-control" name="com" id="comment"
									value="${food.comment }" required="required" />
